...
srcdir = .
topdir = C:/myruby/include/ruby-1.9.1
hdrdir = C:/myruby/include/ruby-1.9.1
arch_hdrdir = C:/myruby/include/ruby-1.9.1/$(arch)
VPATH = $(srcdir);$(arch_hdrdir)/ruby;$(hdrdir)/ruby

DESTDIR = C:
prefix = $(DESTDIR)/myruby
exec_prefix = $(prefix)
...
$(OBJS): {.;$(VPATH)}ruby.h {.;$(VPATH)}defines.h $(arch_hdrdir)/ruby/config.h
